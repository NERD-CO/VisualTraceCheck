function [child_IDs,parent_IDs,child_names,parent_names] = get_parent_GO(term,ontology,GETNAMES);
%
% Current term is also a child term
...
switch ontology
    case 'cc'
        fname = [DATA_DIR 'component.txt'];
        TOP_ID = 5575; % This is for the cellular component   
    case 'mf'
        fname = [DATA_DIR 'function.txt'];
        TOP_ID = 3674; 
    case 'bp'
        fname = [DATA_DIR 'process.txt'];
        TOP_ID = 8150; 
end
