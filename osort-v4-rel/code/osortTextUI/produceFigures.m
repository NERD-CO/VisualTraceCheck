...
for i=1:length(clusters)
    ...
    plotSingleCluster_jat(rawWaveforms, handles.newSpikesTimestampsNegative, handles.assignedClusterNegative, [handles.label '(-)'],  cluNr, colors{i},handles.includeRange, handles); 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
